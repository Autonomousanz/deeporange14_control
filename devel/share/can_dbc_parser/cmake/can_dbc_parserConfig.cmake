...
if("TRUE" STREQUAL "TRUE")
  set(can_dbc_parser_SOURCE_PREFIX /users/sanskrj/Desktop/deeporange14_control/src/pacifica-dbw-ros/can_dbc_parser)
  set(can_dbc_parser_DEVEL_PREFIX /users/sanskrj/Desktop/deeporange14_control/devel)
  ...
  set(can_dbc_parser_INSTALL_PREFIX /users/sanskrj/Desktop/deeporange14_control/install)
...
if(NOT "/users/sanskrj/Desktop/deeporange14_control/src/pacifica-dbw-ros/can_dbc_parser/include " STREQUAL " ")
  set(can_dbc_parser_INCLUDE_DIRS "")
  set(_include_dirs "/users/sanskrj/Desktop/deeporange14_control/src/pacifica-dbw-ros/can_dbc_parser/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'can_dbc_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/users/sanskrj/Desktop/deeporange14_control/src/pacifica-dbw-ros/can_dbc_parser/${idir}'.  ${_report}")
    endif()
