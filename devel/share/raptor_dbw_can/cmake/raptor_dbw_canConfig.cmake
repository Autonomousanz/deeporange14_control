...
if("TRUE" STREQUAL "TRUE")
  set(raptor_dbw_can_SOURCE_PREFIX /users/sanskrj/Desktop/deeporange14_control/src/pacifica-dbw-ros/raptor_dbw_can)
  set(raptor_dbw_can_DEVEL_PREFIX /users/sanskrj/Desktop/deeporange14_control/devel)
  ...
  set(raptor_dbw_can_INSTALL_PREFIX /users/sanskrj/Desktop/deeporange14_control/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'raptor_dbw_can' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/users/sanskrj/Desktop/deeporange14_control/src/pacifica-dbw-ros/raptor_dbw_can/${idir}'.  ${_report}")
    endif()
